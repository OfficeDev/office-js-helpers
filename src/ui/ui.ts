...
export class UI {
    ...
    microsoftLogin(
        ...
        let {button, style} = this._createMicrosoftLoginButton();
    ...
    private _createMicrosoftLoginButton() {
        ...
        style.type = 'text/css';
        style.innerText = this.microsoftLoginButtonCss;

        return { button, style };
    }

    private microsoftLoginButtonCss = `
#microsoft-identity {
    width: 215px;
    height: 41px;
    background: #2F2F2F;
