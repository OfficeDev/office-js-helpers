 ...
 */
export function error(exception: Error, logger?: any)
export function error(exception: string, logger?: any)
export function error(exception: any, logger?: any) {
    if (logger) {
        ...
        if (isAddin() && error instanceof (<any>window).OfficeExtension.Error) {
