...
You can access [these files on unpkg](https://unpkg.com/@microsoft/office-js-helpers@0.5.0/dist/office.helpers.min.js), download them, or point your package manager to them.
