...
setTimeout(function() {
    ...
    fs.readFile(`${projectRoot}/dts/office-js-helpers.d.ts`, 'utf8', function(err, data) {
        if (err) {
        ...
        fs.writeFile(`${projectRoot}/dts/office-js-helpers.d.ts`, result, 'utf8', function(err) {
            if (err) return console.log(err);

            fs.rename(`${projectRoot}/dts/office-js-helpers.d.ts`, `${projectRoot}/dts/office.helpers.d.ts`, function(err) {
                if (err) {
